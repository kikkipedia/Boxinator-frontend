    ...
    return (
        <div>
            {keycloak && !keycloak.authenticated &&
                <Navbar.Brand style={{"color": "white", "fontWeight": "bold", "fontSize": "25px"}} href="/"><img className="navbarImg" src="../resources/images/whiteBox.svg" alt="logo"/> BOXINATOR</Navbar.Brand>
            }
            {keycloak && keycloak.authenticated &&
