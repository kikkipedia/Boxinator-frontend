        ...
        <div>
            ...
            {keycloak && keycloak.authenticated &&
                <AuthorizedElement roles={['user']}>
                    <Navbar.Brand style={{"color": "white", "fonWeight": "bold", "fontSize": "25px"}} href="/user"><img className="navbarImg" src="../resources/images/whiteBox.svg" alt="logo"/> BOXINATOR</Navbar.Brand>
                </AuthorizedElement>
            }
